 ...
 */
class RecipeQuestions extends AbstractActivity
{
    /**
     * @param array $data
    ...
    protected function render($data)
    {
        ...
        return view('user.profile.activity.recipe_questions', $data);
    }
    ...
    {
        /** @var Builder $query */
        $query = RecipeQuestion::forUser($this->currentUser->id)->orderBy('updated_at', 'desc');
