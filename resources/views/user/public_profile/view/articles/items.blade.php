@foreach($articles as $article)
    <li class="item-related">
        <a href="{{ $article->url }}" class="item-related__visual">
            <img src="{{ $article->getImage('articles.list') }}" alt="{{ $article->title }}">
        ...
        <div class="item-related__info">
            ...
            <h4 class="item-related__title"><a href="{{ $article->url }}">{{ $article->title }}</a></h4>
