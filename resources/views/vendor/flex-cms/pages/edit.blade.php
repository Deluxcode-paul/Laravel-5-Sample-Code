...
@section(config('cms-pages.template.contentSection'))
    <div class="row">
        <div class="col-md-12">
            ...
            {{ Form::open(['url' => route('flex.cms.pages.update')]) }}
            {{ Form::hidden('enabled', 1) }}
            {{ Form::hidden('id', $page->id) }}
            {{ Form::hidden('layout', ($page->layout) ? $page->layout : reset($pageLayouts)) }}

            <div class="box">
                <div class="box-body row">
                    <div class="form-group col-md-12 @if($errors->get('title')) has-error @endif" >
                        <label for="title">Title <small>(Required)</small></label>
                        <input type="text" class="form-control" name="title" id="title" value="{{ old('title') ? old('title') : $page->title }}">
                        @if ($errors->get('title'))
                    ...
                    <div class="form-group col-md-12 @if($errors->get('headline')) has-error @endif" >
                        ...
                        <input type="text" class="form-control" name="headline" id="headline" value="{{ old('headline') ? old('headline') : $page->headline }}">
                    ...
                    <div class="form-group col-md-12 @if($errors->get('keywords')) has-error @endif">
                        ...
                        <input type="text" class="form-control" name="keywords" id="keywords" value="{{ old('keywords') ? old('keywords') : $page->keywords }}">
                    ...
                    <div class="form-group col-md-12 @if($errors->get('description')) has-error @endif">
                        ...
                        <input type="text" class="form-control" name="description" id="description" value="{{ old('description') ? old('description') : $page->description }}">
                    ...
                    <div class="form-group col-md-12 @if($errors->get('alias')) has-error @endif">
                        ...
                        <input type="text" class="form-control" name="alias" id="alias" value="{{ old('alias') ? old('alias') : $page->alias }}">
                        @if ($errors->get('alias'))
